...
\section{\li{专业技能}}
\cvdoubleitem{操作系统}{Ubuntu, Fedora, CentOS}{数据库}{MySQL, HBase, Memcached}
\cvdoubleitem{编程语言}{C/C++, Java, Python, Bash, Lua}{文档编写}{LaTeX\footnotemark[2], Word, PPT, Dia}
\cvdoubleitem{日常工具}{Git, GDB, Vim, CMake, Eclipse}{外语水平}{英语~6~级(549)}
